...
#define DNS_DEFAULT_TTL 60 // seconds to cache the resource record
#define DNS_OFFSET_DOMAIN_NAME 12
...
public:
  ...
  // Returns true if successful, false if no sockets available
