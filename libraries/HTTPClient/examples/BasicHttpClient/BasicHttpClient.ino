 ...
 * BasicHttpClient.ino
 *
 *  Adapted for arduino-beken: uses WiFiMulti + external WiFiClient for HTTPClient::begin().
 *
 */
...
const char *httpUrl = "http://example.com/";  // Change this to a reachable HTTP URL
...
void loop() {
  ...
  if (wifiMulti.run() == WL_CONNECTED) {
    // Wait for WSS_GOT_IP before starting TCP/HTTP 
    ...
    // http.begin(client, "https://www.howsmyssl.com/a/check", ca); // HTTPS, requires TLS support
