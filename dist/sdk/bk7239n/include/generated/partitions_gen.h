...
#define CONFIG_FLASH_AES_ENABLE                       0
#define CONFIG_PARTITIONS_NUM                         7
...
#define CONFIG_APPLICATION_PARTITION_SIZE             0x00242000
#define CONFIG_SYS_RF_PARTITION_OFFSET                0x003fe000
#define CONFIG_SYS_RF_PARTITION_SIZE                  0x00001000
#define CONFIG_SYS_NET_PARTITION_OFFSET               0x003ff000
#define CONFIG_SYS_NET_PARTITION_SIZE                 0x00001000
#define CONFIG_OTA_PARTITION_OFFSET                   0x00253000
#define CONFIG_OTA_PARTITION_SIZE                     0x00187000
#define CONFIG_USR_CONFIG_PARTITION_OFFSET            0x003da000
#define CONFIG_USR_CONFIG_PARTITION_SIZE              0x00022000
#define CONFIG_EASYFLASH_PARTITION_OFFSET             0x003fc000
...
#define BK_FLASH_PARTITIONS_MAP { \
    ...
    [8] = {BK_FLASH_EMBEDDED, "easyflash", CONFIG_EASYFLASH_PARTITION_OFFSET, CONFIG_EASYFLASH_PARTITION_SIZE, PAR_OPT_EXECUTE_DIS | PAR_OPT_READ_EN | PAR_OPT_WRITE_EN}, \
}
