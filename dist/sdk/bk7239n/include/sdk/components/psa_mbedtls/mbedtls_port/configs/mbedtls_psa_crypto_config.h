...
#define PSA_TAG "psa"
#define PSA_LOGI(...) BK_LOGI(PSA_TAG, ##__VA_ARGS__)
#define PSA_LOGW(...) BK_LOGW(PSA_TAG, ##__VA_ARGS__)
#define PSA_LOGE(...) BK_LOGE(PSA_TAG, ##__VA_ARGS__)
#define PSA_LOGD(...) BK_LOGD(PSA_TAG, ##__VA_ARGS__)
